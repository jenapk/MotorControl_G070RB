...
#define EPR_BUS_SPEED                       100000                 	/* Max I2C Bus speed (Hz) */
#define EPR_DEVICE_START_ADDR               0                  		/* EEPROM device start address */
#define EPR_DEVICE_SIZE                     32768                 	/* EEPROM device size (total bytes) 8*1024 */
#define EPR_DEVICE_PAGESIZE                 64                    	/* 32 bytes/page */
#define EPR_DEVICE_WRITE_CYCLE_TIME         (10000)                  /* Spec is 5ms */
...
#define EPR_WRITE_MAX_TIMEOUT               (1000)	//(uint32_t)(EPR_1BYTE_TIMEOUT * (EPR_DEVICE_PAGESIZE+1)))   /* Page bytes + 1 offset */
