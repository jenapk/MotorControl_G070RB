...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LCD_D0_Pin|LCD_D1_Pin|LCD_D2_Pin|LED_RUN_Pin
                          |LED_ERR_Pin|LCD_D3_Pin|LCD_D4_Pin|LCD_D5_Pin
  ...
  /*Configure GPIO pins : LCD_D0_Pin LCD_D1_Pin LCD_D2_Pin LED_RUN_Pin
                           LED_ERR_Pin LCD_D3_Pin LCD_D4_Pin LCD_D5_Pin
                           LCD_D6_Pin LCD_D7_Pin LCD_PWR_Pin LED_HEALTH_Pin */
  GPIO_InitStruct.Pin = LCD_D0_Pin|LCD_D1_Pin|LCD_D2_Pin|LED_RUN_Pin
                          |LED_ERR_Pin|LCD_D3_Pin|LCD_D4_Pin|LCD_D5_Pin
                          |LCD_D6_Pin|LCD_D7_Pin|LCD_PWR_Pin|LED_HEALTH_Pin;
  ...
  /*Configure GPIO pins : RELAY_CAP_3_Pin GSM_PWR_Pin GSM_RESET_Pin */
  GPIO_InitStruct.Pin = RELAY_CAP_3_Pin|GSM_PWR_Pin|GSM_RESET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
